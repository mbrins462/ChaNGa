...
CHARM_PATH = /home/mbrinson/Libraries/charm-6.7.1
...
LDLIBS += $(STRUCTURES_PATH)/libTipsy.a   -lifcore
...
myhelmholtz.o: 
	$(CHARMC) -o myhelmholtz.o $(OPTS) helmholtz/myhelmholtz.f90

burn.o: 
	$(CHARMC) -o burn.o $(OPTS) nuclear/burn.f90
