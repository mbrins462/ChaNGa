#ifndef COOLING_HELM_HINCLUDED
#define COOLING_HELM_HINCLUDED
/*
...
void CoolInitEnergyAndParticleData( COOL *cl, COOLPARTICLE *cp, double *E,
    double dDensity, double dTemp, double fMetal);//, double *CarbonMF, double *OxygenMF);//FIXME
...
void clIntegrateEnergy(COOL *cl, double *E, double PdV, double rho, double tStep);
#ifdef __cplusplus
}
#endif
