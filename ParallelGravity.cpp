...
Main::Main(CkArgMsg* m) {
  ...
  int threadNum = CkMyNodeSize();
	...
	param.bDoAprox13 = 0;
	prmAddParam(prm,"bDoAprox13",paramBool,&param.bDoAprox13,sizeof(int),
		    "aprox13","enable/disable nuclear burning");
	param.nSmooth = 32;
...
#ifdef COOLING_NUC
	      HeFourOutputParams pHeFourOut(achFile, param.iBinaryOut, 0.0);
	      CTwelveOutputParams pCTwelveOut(achFile, param.iBinaryOut, 0.0);
	      OSixteenOutputParams pOSixteenOut(achFile, param.iBinaryOut, 0.0);
	      NeTwentyOutputParams pNeTwentyOut(achFile, param.iBinaryOut, 0.0);
	      MgTwentyFourOutputParams pMgTwentyFourOut(achFile, param.iBinaryOut, 0.0);
	      SiTwentyEightOutputParams pSiTwentyEightOut(achFile, param.iBinaryOut, 0.0);
	      SThirtyTwoOutputParams pSThirtyTwoOut(achFile, param.iBinaryOut, 0.0);
	      ArThirtySixOutputParams pArThirtySixOut(achFile, param.iBinaryOut, 0.0);
	      CaFortyOutputParams pCaFortyOut(achFile, param.iBinaryOut, 0.0);
	      TiFortyFourOutputParams pTiFortyFourOut(achFile, param.iBinaryOut, 0.0);
	      CrFortyEightOutputParams pCrFortyEightOut(achFile, param.iBinaryOut, 0.0);
	      FeFiftyTwoOutputParams pFeFiftyTwoOut(achFile, param.iBinaryOut, 0.0);
	      NiFiftySixOutputParams pNiFiftySixOut(achFile, param.iBinaryOut, 0.0);
#endif
              if (param.iBinaryOut) {
                  ...
                  outputBinary(pCsOut, param.bParaWrite,
                      CkCallbackResumeThread());
#ifdef COOLING_NUC
		  outputBinary(pHeFourOut, param.bParaWrite,
		      CkCallbackResumeThread());
		  outputBinary(pCTwelveOut, param.bParaWrite,
		      CkCallbackResumeThread());
		  outputBinary(pOSixteenOut, param.bParaWrite,
		      CkCallbackResumeThread());
		  outputBinary(pNeTwentyOut, param.bParaWrite,
		      CkCallbackResumeThread());
		  outputBinary(pMgTwentyFourOut, param.bParaWrite,
		      CkCallbackResumeThread());
		  outputBinary(pSiTwentyEightOut, param.bParaWrite,
		      CkCallbackResumeThread());
		  outputBinary(pSThirtyTwoOut, param.bParaWrite,
		      CkCallbackResumeThread());
		  outputBinary(pArThirtySixOut, param.bParaWrite,
		      CkCallbackResumeThread());
		  outputBinary(pCaFortyOut, param.bParaWrite,
		      CkCallbackResumeThread());
		  outputBinary(pTiFortyFourOut, param.bParaWrite,
		      CkCallbackResumeThread());
		  outputBinary(pCrFortyEightOut, param.bParaWrite,
		      CkCallbackResumeThread());
		  outputBinary(pFeFiftyTwoOut, param.bParaWrite,
		      CkCallbackResumeThread());
		  outputBinary(pNiFiftySixOut, param.bParaWrite,
		      CkCallbackResumeThread());
#endif
#ifndef COOLING_NONE
                  if(param.bGasCooling) {
...
#ifdef COOLING_NUC
		  treeProxy[0].outputASCII(pHeFourOut, param.bParaWrite, CkCallbackResumeThread());
		  treeProxy[0].outputASCII(pCTwelveOut, param.bParaWrite, CkCallbackResumeThread());
		  treeProxy[0].outputASCII(pOSixteenOut, param.bParaWrite, CkCallbackResumeThread());
		  treeProxy[0].outputASCII(pNeTwentyOut, param.bParaWrite, CkCallbackResumeThread());
		  treeProxy[0].outputASCII(pMgTwentyFourOut, param.bParaWrite, CkCallbackResumeThread());
		  treeProxy[0].outputASCII(pSiTwentyEightOut, param.bParaWrite, CkCallbackResumeThread());
		  treeProxy[0].outputASCII(pSThirtyTwoOut, param.bParaWrite, CkCallbackResumeThread());
		  treeProxy[0].outputASCII(pArThirtySixOut, param.bParaWrite, CkCallbackResumeThread());
		  treeProxy[0].outputASCII(pCaFortyOut, param.bParaWrite, CkCallbackResumeThread());
		  treeProxy[0].outputASCII(pTiFortyFourOut, param.bParaWrite, CkCallbackResumeThread());
		  treeProxy[0].outputASCII(pCrFortyEightOut, param.bParaWrite, CkCallbackResumeThread());
		  treeProxy[0].outputASCII(pFeFiftyTwoOut, param.bParaWrite, CkCallbackResumeThread());
		  treeProxy[0].outputASCII(pNiFiftySixOut, param.bParaWrite, CkCallbackResumeThread());
...
#ifdef COOLING_NUC
    HeFourOutputParams pHeFourOut(achFile, param.iBinaryOut, dOutTime);
    CTwelveOutputParams pCTwelveOut(achFile, param.iBinaryOut, dOutTime);
    OSixteenOutputParams pOSixteenOut(achFile, param.iBinaryOut, dOutTime);
    NeTwentyOutputParams pNeTwentyOut(achFile, param.iBinaryOut, dOutTime);
    MgTwentyFourOutputParams pMgTwentyFourOut(achFile, param.iBinaryOut, dOutTime);
    SiTwentyEightOutputParams pSiTwentyEightOut(achFile, param.iBinaryOut, dOutTime);
    SThirtyTwoOutputParams pSThirtyTwoOut(achFile, param.iBinaryOut, dOutTime);
    ArThirtySixOutputParams pArThirtySixOut(achFile, param.iBinaryOut, dOutTime);
    CaFortyOutputParams pCaFortyOut(achFile, param.iBinaryOut, dOutTime);
    TiFortyFourOutputParams pTiFortyFourOut(achFile, param.iBinaryOut, dOutTime);
    CrFortyEightOutputParams pCrFortyEightOut(achFile, param.iBinaryOut, dOutTime);
    FeFiftyTwoOutputParams pFeFiftyTwoOut(achFile, param.iBinaryOut, dOutTime);
    NiFiftySixOutputParams pNiFiftySixOut(achFile, param.iBinaryOut, dOutTime);
#endif
...
#ifdef COOLING_NUC
	if(param.bDoAprox13) {
	    outputBinary(pHeFourOut, param.bParaWrite, CkCallbackResumeThread());
	    outputBinary(pCTwelveOut, param.bParaWrite, CkCallbackResumeThread());
	    outputBinary(pOSixteenOut, param.bParaWrite, CkCallbackResumeThread());
	    outputBinary(pNeTwentyOut, param.bParaWrite, CkCallbackResumeThread());
	    outputBinary(pMgTwentyFourOut, param.bParaWrite, CkCallbackResumeThread());
	    outputBinary(pSiTwentyEightOut, param.bParaWrite, CkCallbackResumeThread());
	    outputBinary(pSThirtyTwoOut, param.bParaWrite, CkCallbackResumeThread());
	    outputBinary(pArThirtySixOut, param.bParaWrite, CkCallbackResumeThread());
	    outputBinary(pCaFortyOut, param.bParaWrite, CkCallbackResumeThread());
	    outputBinary(pTiFortyFourOut, param.bParaWrite, CkCallbackResumeThread());
	    outputBinary(pCrFortyEightOut, param.bParaWrite, CkCallbackResumeThread());
	    outputBinary(pFeFiftyTwoOut, param.bParaWrite, CkCallbackResumeThread());
	    outputBinary(pNiFiftySixOut, param.bParaWrite, CkCallbackResumeThread());
	    }
#endif
...
#ifdef COOLING_NUC
	if(param.bDoAprox13) {
	    treeProxy[0].outputASCII(pHeFourOut, param.bParaWrite,
				      CkCallbackResumeThread());
	    treeProxy[0].outputASCII(pCTwelveOut, param.bParaWrite,
				      CkCallbackResumeThread());
	    treeProxy[0].outputASCII(pOSixteenOut, param.bParaWrite,
				      CkCallbackResumeThread());
	    treeProxy[0].outputASCII(pNeTwentyOut, param.bParaWrite,
				      CkCallbackResumeThread());
	    treeProxy[0].outputASCII(pMgTwentyFourOut, param.bParaWrite,
				      CkCallbackResumeThread());
	    treeProxy[0].outputASCII(pSiTwentyEightOut, param.bParaWrite,
				      CkCallbackResumeThread());
	    treeProxy[0].outputASCII(pSThirtyTwoOut, param.bParaWrite,
				      CkCallbackResumeThread());
	    treeProxy[0].outputASCII(pArThirtySixOut, param.bParaWrite,
				      CkCallbackResumeThread());
	    treeProxy[0].outputASCII(pCaFortyOut, param.bParaWrite,
				      CkCallbackResumeThread());
	    treeProxy[0].outputASCII(pTiFortyFourOut, param.bParaWrite,
				      CkCallbackResumeThread());
	    treeProxy[0].outputASCII(pCrFortyEightOut, param.bParaWrite,
				      CkCallbackResumeThread());
	    treeProxy[0].outputASCII(pFeFiftyTwoOut, param.bParaWrite,
				      CkCallbackResumeThread());
	    treeProxy[0].outputASCII(pNiFiftySixOut, param.bParaWrite,
				      CkCallbackResumeThread());
	    }
#endif
	if(param.bDoIOrderOutput || param.bStarForm || param.bFeedback) {
