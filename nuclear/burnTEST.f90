...
! declare
      ...
      double precision ti,di,ei,vi,zi,xi(18)
      integer          iter

! variables used with subroutine driveburner
      double precision temp_in, density_in, energy_in, velocity_in, &
                       position_in, he4_massfrac_in, c12_massfrac_in, &
                       o16_massfrac_in, ne20_massfrac_in, mg24_massfrac_in, &
                       si28_massfrac_in, s32_massfrac_in, ar36_massfrac_in, &
                       ca40_massfrac_in, ti44_massfrac_in, cr48_massfrac_in, &
                       fe52_massfrac_in, ni56_massfrac_in, &
                       temp_out, density_out, energy_out, he4_massfrac_out, &
                       c12_massfrac_out, o16_massfrac_out, ne20_massfrac_out, &
                       mg24_massfrac_out, si28_massfrac_out, s32_massfrac_out, &
                       ar36_massfrac_out, ca40_massfrac_out, ti44_massfrac_out, &
                       cr48_massfrac_out, fe52_massfrac_out, ni56_massfrac_out
    
      double precision tstart_i, temp_i, density_i, velocity_i, position_i, &
                       he4_massfrac_i, c12_massfrac_i, o16_massfrac_i, &
                       ne20_massfrac_i, mg24_massfrac_i, si28_massfrac_i, &
                       s32_massfrac_i, ar36_massfrac_i, ca40_massfrac_i, &
                       ti44_massfrac_i, cr48_massfrac_i, fe52_massfrac_i, &
                       ni56_massfrac_i

      double precision massfrac_array_in(13), massfrac_array_out(13)

! initialize the network and eos
      print *, 'Calling read_helm_table'
      call read_helm_table
       ...
       ife56 = 0
       ini56 = 0
      print *, 'Calling init_aprox13'
      call init_aprox13

! keep coming back to here
20    continue
! start the clockdd
      print *, 'Calling zsecond'
      call zsecond(timzer)
      print *, 'Calling net_input'
!      call net_input(tstart,tstep,temp_in,density_in,velocity_in,position_in,energy_in,massfrac_array_in)
!      ti = tin
!      di = din
!      vi = vin
!      zi = zin
...
!      do iter = 1,1 
      ...
      c12_massfrac_in = 0.5
      o16_massfrac_in = 0.5
      ne20_massfrac_in = 0.0
      mg24_massfrac_in = 0.0
      si28_massfrac_in = 0.0
      s32_massfrac_in = 0.0
      ar36_massfrac_in = 0.0
      ca40_massfrac_in = 0.0
      ti44_massfrac_in = 0.0
      cr48_massfrac_in = 0.0
      fe52_massfrac_in = 0.0
      ni56_massfrac_in = 0.0
...
! a message
      tstep = 0.05D0
      print *, 'Calling drive_burner...'
      call drive_burner(tstart, tstep, &
                       temp_in, temp_out, &
                       energy_in, energy_out, &
                       density_in, density_out, &
                       he4_massfrac_in, he4_massfrac_out, &
                       c12_massfrac_in, c12_massfrac_out, &
                       o16_massfrac_in, o16_massfrac_out, &
                       ne20_massfrac_in, ne20_massfrac_out, &
                       mg24_massfrac_in, mg24_massfrac_out, &
                       si28_massfrac_in, si28_massfrac_out, &
                       s32_massfrac_in, s32_massfrac_out, &
                       ar36_massfrac_in, ar36_massfrac_out, &
                       ca40_massfrac_in, ca40_massfrac_out, &
                       ti44_massfrac_in, ti44_massfrac_out, &
                       cr48_massfrac_in, cr48_massfrac_out, &
                       fe52_massfrac_in, fe52_massfrac_out, &
                       ni56_massfrac_in, ni56_massfrac_out, &
                       massfrac_array_out, &
                       conserv, nok, nbad)
...
! output a summary of the integration
      ...
      print *, 'Calling net_summary'
      call net_summary(tstep,temp_in,density_in,energy_in, &
                        temp_out,density_out,energy_out,conserv, &
                        nbad,nok,massfrac_array_out)
...
! this is my subroutine which calls burner
! and uses aprox13

      subroutine drive_burner(tstart, tstep, &
                             temp_in, temp_out, &
                             energy_in, energy_out, &
                             density_in, density_out, &
                             he4_massfrac_in, he4_massfrac_out, &
                             ...
                             fe52_massfrac_in, fe52_massfrac_out, &
                             ni56_massfrac_in, ni56_massfrac_out, &
                             massfrac_array_out, conserv, nok, nbad)
      include 'implno.dek'
      include 'const.dek'
      include 'timers.dek'
      include 'burn_common.dek'
      include 'network.dek'
      ! declare arguments for drive_burner
      double precision tstart, tstep, &
                       energy_in, energy_out, &
                       temp_in, temp_out, &
                       density_in, density_out, &
                       he4_massfrac_in, he4_massfrac_out, &
      ...
      ! declare arguments used in burner
      integer          nok,nbad
      double precision velocity_in,position_in, &
                       conserv
      double precision massfrac_array_in(13), massfrac_array_out(13)
    
      ! MB: This is the type of burning we are undertaking.`
      self_heat_const_den = .true.
      id_stop = 1
      xmass_stop = -1d30
      ! put the input abundances into an array for burner input
      massfrac_array_in (1) = he4_massfrac_in
      massfrac_array_in (2) = c12_massfrac_in
      massfrac_array_in (3) = o16_massfrac_in
      massfrac_array_in (4) = ne20_massfrac_in
      massfrac_array_in (5) = mg24_massfrac_in
      massfrac_array_in (6) = si28_massfrac_in
      massfrac_array_in (7) = s32_massfrac_in
      massfrac_array_in (8) = ar36_massfrac_in
      massfrac_array_in (9) = ca40_massfrac_in
      massfrac_array_in (10) = ti44_massfrac_in
      massfrac_array_in (11) = cr48_massfrac_in
      massfrac_array_in (12) = fe52_massfrac_in
      massfrac_array_in (13) = ni56_massfrac_in
      

      call burner(tstart,tstep, &
                  temp_in,density_in,velocity_in,position_in,energy_in,massfrac_array_in, &
                  temp_out,density_out,energy_out,massfrac_array_out, &
                  conserv,nok,nbad)

      ! unpack the burner output abundances
      he4_massfrac_out = massfrac_array_out (1) 
      c12_massfrac_out = massfrac_array_out (2) 
      o16_massfrac_out = massfrac_array_out (3) 
      ne20_massfrac_out = massfrac_array_out (4)
      mg24_massfrac_out = massfrac_array_out (5)
      si28_massfrac_out = massfrac_array_out (6)
      s32_massfrac_out = massfrac_array_out (7) 
      ar36_massfrac_out = massfrac_array_out (8) 
      ca40_massfrac_out = massfrac_array_out (9) 
      ti44_massfrac_out = massfrac_array_out (10)
      cr48_massfrac_out = massfrac_array_out (11)
      fe52_massfrac_out = massfrac_array_out (12)
      ni56_massfrac_out = massfrac_array_out (13)
    
      return
      end subroutine drive_burner
...
! gets some exercise if tstep is large in single step mode.
      ...
      if (one_step) then
       ...
       stptry = max(tstep * 1.0d-2,1.0d-16)
       stpmin = tstep * 1.0d-20
      end if
...
! local variables
      ...
      integer          i,j
      double precision zz,xx,yy

      double precision zbarxx,z2barxx,ytot1,abar,zbar,z2bar,taud,taut, &
                       snuda,snudz,ye, &
                       enuc,velx,posx,suma,sumz,ssum, &
                       sum5,sum6,sum7,sum8,sum9,sum10,sum11,sum12, &
                       cs,denombv,dpde,dpdebd,dpdebt,phi,phibd,phibt, &
                       combo,combobv,combobd,combobt,z,zbd,zbt, &
                       ww,wwbd,wwbt,dtdp,dtdpbd,dtdpbt, &
                       dpdbd,dpdbt,foo(8),moo(8), &
                       csbd,csbt,dptbd,dptbt,detbd,detbt,dpabd,dpabt, &
                       dpzbd,dpzbt,deabd,deabt,dezbd,dezbt, &
...
! append the energy generation rate jacobian elements
      do j=ionbeg,ionend
       ...
       dfdy(iener,itemp) = dfdy(iener,itemp) &
                                 + dfdy(j,itemp)*mion(j)
       dfdy(iener,iden)  = dfdy(iener,iden) &
                                 + dfdy(j,iden)*mion(j)
      enddo
...
! get the right hand sides
       call rhs(y,ratdum,zwork1,deriva)


! instantaneous energy generation rate
       call ener_gener_rate(zwork1,enuc)
...
! appears we need the derivatives of derivatibe based eos quantities. grrr.
       z    = bden
       xx   = 0.01d0*z
       bden = z + xx
       temp_row(1) = btemp
...
! for de/dy and dp/dy
       suma = -sum(zwork1(ionbeg:ionend))
       sumz = sum((zion(ionbeg:ionend) - zbar)*zwork1(ionbeg:ionend))

       ssum = 0.0d0
       do i=ionbeg,ionend
        ssum = ssum - dfdy(i,iden)
       enddo
       sum5 = ssum * dea_row(1)*abar*abar
       sum9 = ssum * dpa_row(1)*abar*abar

       ssum = 0.0d0
       do i=ionbeg,ionend
        ssum = ssum + (zion(i) - zbar)*dfdy(i,iden)
       enddo
       sum6  = ssum * dez_row(1)*abar
       sum10 = ssum * dpz_row(1)*abar

       ssum = 0.0d0
       do i=ionbeg,ionend
        ssum = ssum - dfdy(i,itemp)
       enddo
       sum7 = ssum * dea_row(1)*abar*abar
       sum11 = ssum * dpa_row(1)*abar*abar

       ssum = 0.0d0
       do i=ionbeg,ionend
        ssum = ssum + (zion(i) - zbar)*dfdy(i,itemp)
       enddo
       sum8  = ssum * dez_row(1)*abar
       sum12 = ssum * dpz_row(1)*abar
...
! the function phi
       ...
       phibd  = dpdebd*(zwork1(iener) - ww) - zbd &
                + dpde*(dfdy(iener,iden) - wwbd)

       phibt  = dpdebt*(zwork1(iener) - ww) - zbt &
                + dpde*(dfdy(iener,itemp) - wwbt)
       ...
       do j=ionbeg,ionend
        ...
        do i=ionbeg,ionend
         xx = xx + dfdy(i,j)*(-dea_row(1)*abar*abar &
                                    + dez_row(1)*(zion(i)-zbar)*abar)
         ww = ww + dfdy(i,j)*(-dpa_row(1)*abar*abar &
                                    + dpz_row(1)*(zion(i)-zbar)*abar)
        enddo
...
! velocity equation
       ...
       dfdy(ivelx,ivelx) = -zwork1(iden)/bden &
                                 - z*dfdy(iden,ivelx)
       dfdy(ivelx,iden)  = z/bden*zwork1(iden) &
                                 - z*dfdy(iden,iden)
...
! temperature equation
       ...
       zwork1(itemp)    = dtdp*((velx*velx &
                                    - dpd_row(1))*zwork1(iden) - ww)

       dfdy(itemp,ivelx) = dtdp*(2.0d0*velx*zwork1(iden) &
                                 + (velx*velx - dpd_row(1)) &
                                    * dfdy(iden,ivelx))

       dfdy(itemp,iden)  = dtdpbd*((velx*velx-dpd_row(1)) &
                                 * zwork1(iden)-ww) &
                                + dtdp*((velx*velx-dpd_row(1)) &
                                 * dfdy(iden,iden) &
                                 - dpdbd*zwork1(iden) &
                                 - wwbd)

       dfdy(itemp,itemp) = dtdpbt*((velx*velx-dpd_row(1)) &
                                 * zwork1(iden)-ww) &
                                + dtdp*((velx*velx-dpd_row(1)) &
                                 * dfdy(iden,itemp) &
                                  - dpdbt*zwork1(iden) &
...
!        enddo
        dfdy(itemp,j) = dtdp*((velx*velx - dpd_row(1)) &
                                     * dfdy(iden,j) -ww)
       enddo
...
! detonation
       ...
       call tree(iposx,iposx,eloc,neloc,nterms,nzo,iloc,jloc,np)
       call tree(iposx,ivelx,eloc,neloc,nterms,nzo,iloc,jloc,np)
       call tree(iden,ivelx,eloc,neloc,nterms,nzo,iloc,jloc,np)
       call tree(iden,iden,eloc,neloc,nterms,nzo,iloc,jloc,np)
       ...
       call tree(itemp,ivelx,eloc,neloc,nterms,nzo,iloc,jloc,np)
       call tree(itemp,iden,eloc,neloc,nterms,nzo,iloc,jloc,np)
       call tree(itemp,itemp,eloc,neloc,nterms,nzo,iloc,jloc,np)
       do i=ionbeg,ionend
        call tree(itemp,i,eloc,neloc,nterms,nzo,iloc,jloc,np)
...
! now fill irow and icol
!      if (nzo .gt. np) stop 'nzo > np in routine baprox13'
!      call tree_out(iloc,jloc,nzo,np)
...
!      write(6,*) ' '
      ...
      subroutine saprox13(tt,y,dfdy,nzo)
      include 'implno.dek'
      include 'const.dek'
      include 'burn_common.dek'
      include 'network.dek'
...
! local variables
      ...
      parameter        (deriva = .true.)
      integer          i,nt,iat
      double precision zz,xx,a1,a2,a3,a4

      double precision zbarxx,z2barxx,ytot1,abar,zbar,z2bar,taud,taut, &
                       snuda,snudz,ye, &
                       enuc,velx,posx,suma,sumz,sum1,sum, &
                       sum5,sum6,sum7,sum8,sum9,sum10,sum11,sum12, &
                       cs,denombv,dpde,dpdebd,dpdebt,phi,phibd,phibt, &
                       combo,combobv,combobd,combobt,z,zbd,zbt, &
                       ww,wwbd,wwbt,dtdp,dtdpbd,dtdpbt, &
                       dpdbd,dpdbt,foo(8),moo(8),enucbd,enucbt, &
                       csbd,csbt,dptbd,dptbt,detbd,detbt,dpabd,dpabt, &
                       dpzbd,dpzbt,deabd,deabt,dezbd,dezbt, &
                       denom,denomdt,denomdd
...
! d(he4)/d(c12)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ic12) = xsum(ic12) + a1 * mion(ihe4)
...
! d(he4)/d(o16)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(io16) = xsum(io16) + a1 * mion(ihe4)
...
! d(he4)/d(ne20)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ine20) = xsum(ine20) + a1 * mion(ihe4)
...
! d(he4)/d(mg24)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(img24) = xsum(img24) + a1 * mion(ihe4)
...
! d(he4)/d(si28)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(isi28) = xsum(isi28) + a1 * mion(ihe4)
...
! d(he4)/d(s32)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(is32) = xsum(is32) + a1 * mion(ihe4)
...
! d(he4)/d(ar36)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(iar36) = xsum(iar36) + a1 * mion(ihe4)
...
! d(he4)/d(ca40)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ica40) = xsum(ica40) + a1 * mion(ihe4)
...
! d(he4)/d(ti44)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(iti44) = xsum(iti44) + a1 * mion(ihe4)
...
! d(he4)/d(cr48)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(icr48) = xsum(icr48) + a1 * mion(ihe4)
...
! d(he4)/d(fe52)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ife52) = xsum(ife52) + a1 * mion(ihe4)
...
! d(he4)/d(ni56)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ini56) = xsum(ini56) + a1 * mion(ihe4)
...
! d(c12)/d(he4)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ihe4) = xsum(ihe4) + a1 * mion(ic12)


! d(c12)/d(c12)
      a1  = -2.0d0 * y(ic12) * ratdum(ir1212) &
           - y(io16) * ratdum(ir1216) &
           - ratdum(irg3a) &
           - y(ihe4) * ratdum(ircag)
      nt  = nt + 1
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ic12) = xsum(ic12) + a1 * mion(ic12)
...
! d(c12)/d(o16)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(io16) = xsum(io16) + a1 * mion(ic12)
...
! d(o16)/d(he4)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ihe4) = xsum(ihe4) + a1 * mion(io16)
...
! d(o16)/d(c12)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ic12) = xsum(ic12) + a1 * mion(io16)
...
! d(o16)/d(o16)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(io16) = xsum(io16) + a1 * mion(io16)
...
! d(o16)/d(ne20)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ine20) = xsum(ine20) + a1 * mion(io16)
...
! d(ne20)/d(he4)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ihe4) = xsum(ihe4) + a1 * mion(ine20)
...
! d(ne20)/d(c12)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ic12) = xsum(ic12) + a1 * mion(ine20)
...
! d(ne20)/d(o16)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(io16) = xsum(io16) + a1 * mion(ine20)
...
! d(ne20)/d(ne20)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ine20) = xsum(ine20) + a1 * mion(ine20)
...
! d(ne20)/d(mg24)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(img24) = xsum(img24) + a1 * mion(ine20)
...
! d(mg24)/d(he4)
      ...
      iat  = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ihe4) = xsum(ihe4) + a1 * mion(img24)
...
! d(mg24)/d(c12)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ic12) = xsum(ic12) + a1 * mion(img24)
...
! d(mg24)/d(o16)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(io16) = xsum(io16) + a1 * mion(img24)
...
! d(mg24)/d(ne20)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ine20) = xsum(ine20) + a1 * mion(img24)
...
! d(mg24)/d(mg24)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(img24) = xsum(img24) + a1 * mion(img24)
...
! d(mg24)/d(si28)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(isi28) = xsum(isi28) + a1 * mion(img24)
...
! d(si28)/d(he4)
      ...
      iat  = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ihe4) = xsum(ihe4) + a1 * mion(isi28)
...
! d(si28)/d(c12)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ic12) = xsum(ic12) + a1 * mion(isi28)
...
! d(si28)/d(o16)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(io16) = xsum(io16) + a1 * mion(isi28)
...
! d(si28)/d(mg24)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(img24) = xsum(img24) + a1 * mion(isi28)
...
! d(si28)/d(si28)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(isi28) = xsum(isi28) + a1 * mion(isi28)
...
! d(si28)/d(s32)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(is32) = xsum(is32) + a1 * mion(isi28)
...
! d(s32)/d(he4)
      ...
      iat  = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ihe4) = xsum(ihe4) + a1 * mion(is32)

! d(s32)/d(o16)
      a1  =  0.68d0*0.5d0*y(io16)*ratdum(ir1616)*(1.0d0-ratdum(irs1)) &
            + 0.2d0 * 0.5d0*y(io16) * ratdum(ir1616)
      nt  = nt + 1
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(io16) = xsum(io16) + a1 * mion(is32)
...
! d(s32)/d(si28)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(isi28) = xsum(isi28) + a1 * mion(is32)
...
! d(s32)/d(s32)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(is32) = xsum(is32) + a1 * mion(is32)
...
! d(s32)/d(ar36)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(iar36) = xsum(iar36) + a1 * mion(is32)
...
! d(ar36)/d(he4)
      ...
      iat  = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ihe4) = xsum(ihe4) + a1 * mion(iar36)
...
! d(ar36)/d(s32)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(is32) = xsum(is32) + a1 * mion(iar36)
...
! d(ar36)/d(ar36)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(iar36) = xsum(iar36) + a1 * mion(iar36)
...
! d(ar36)/d(ca40)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ica40) = xsum(ica40) + a1 * mion(iar36)
...
! d(ca40)/d(he4)
      ...
      iat  = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ihe4) = xsum(ihe4) + a1 * mion(ica40)
...
! d(ca40)/d(ar36)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(iar36) = xsum(iar36) + a1 * mion(ica40)
...
! d(ca40)/d(ca40)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ica40) = xsum(ica40) + a1 * mion(ica40)
...
! d(ca40)/d(ti44)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(iti44) = xsum(iti44) + a1 * mion(ica40)
...
! d(ti44)/d(he4)
      ...
      iat  = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ihe4) = xsum(ihe4) + a1 * mion(iti44)
...
! d(ti44)/d(ca40)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ica40) = xsum(ica40) + a1 * mion(iti44)
...
! d(ti44)/d(ti44)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(iti44) = xsum(iti44) + a1 * mion(iti44)
...
! d(ti44)/d(cr48)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(icr48) = xsum(icr48) + a1 * mion(iti44)
...
! d(cr48)/d(he4)
      ...
      iat  = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ihe4) = xsum(ihe4) + a1 * mion(icr48)
...
! d(cr48)/d(ti44)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(iti44) = xsum(iti44) + a1 * mion(icr48)
...
! d(cr48)/d(cr48)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(icr48) = xsum(icr48) + a1 * mion(icr48)
...
! d(cr48)/d(fe52)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ife52) = xsum(ife52) + a1 * mion(icr48)
...
! d(fe52)/d(he4)
      ...
      iat  = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ihe4) = xsum(ihe4) + a1 * mion(ife52)
...
! d(fe52)/d(cr48)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(icr48) = xsum(icr48) + a1 * mion(ife52)
...
! d(fe52)/d(fe52)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ife52) = xsum(ife52) + a1 * mion(ife52)
...
! d(fe52)/d(ni56)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ini56) = xsum(ini56) + a1 * mion(ife52)
...
! d(ni56)/d(he4)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ihe4) = xsum(ihe4) + a1 * mion(ini56)
...
! d(ni56)/d(fe52)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ife52) = xsum(ife52) + a1 * mion(ini56)
...
! d(ni56)/d(ni56)
      ...
      iat = eloc(nt)
      dfdy(iat) = dfdy(iat) + a1
      xsum(ini56) = xsum(ini56) + a1 * mion(ini56)
...
! d(ener)/d(yi)
      do i=ionbeg,ionend
       a1  = -((aion(i) - abar)*abar*snuda + (zion(i) - zbar)*abar*snudz)
       nt  = nt + 1
       iat = eloc(nt)
       dfdy(iat) = dfdy(iat) + a1
      enddo
...
! it appears as if we need the derivatives of derivative based
! eos quantities. grrr.
       z    = bden
       xx   = 0.01d0*z
       bden = z + xx
...
! d(ivelx)/d(iden)
       a1  = z/bden*zwork1(iden) - z*combobd
       a1  = 0.0d0
       nt  = nt + 1
       iat = eloc(nt)
       dfdy(iat) = dfdy(iat) + a1
...
! d(itemp)/d(ivelx)
       a1  = dtdp*(2.0d0*velx*zwork1(iden) &
                          +   (velx*velx - dpd_row(1))*combobv)
       a1  = 0.0d0
       nt  = nt + 1
       iat = eloc(nt)
       dfdy(iat) = dfdy(iat) + a1
...
! d(itemp)/d(iden)
       a1  = dtdpbd*((velx*velx-dpd_row(1))*zwork1(iden)-ww) &
                         + dtdp*((velx*velx-dpd_row(1))*combobd &
                                 - dpdbd*zwork1(iden) &
                                 - wwbd)
       a1  = 0.0d0
       nt  = nt + 1
...
! d(itemp)/d(itemp)
       a1  = dtdpbt*((velx*velx-dpd_row(1))*zwork1(iden)-ww) &
                         + dtdp*((velx*velx-dpd_row(1))*combobt &
                                  - dpdbt*zwork1(iden) &
                                  - wwbt)
       a1  = 0.0d0
       nt  = nt + 1
...
! d(itemp)/d(yi)
       ...
       zz  = dpde*xx
       do i=ionbeg,ionend
        a3  = zz*xsum(i) * enuc_conv2
        a1  = dtdp * ((velx*velx - dpd_row(1)) * a3)
        a1  = 0.0d0
        nt  = nt + 1
        iat = eloc(nt)
        dfdy(iat) = dfdy(iat) + a1
...
! bullet check the counting
 678  if (nt .ne. nterms) then
       ...
       write(6,*) 'error in routine saprox13: nt .ne. nterms'
       stop 'error in routine saprox13'
      end if
...
! THIS STATEMENT IS TRUE, ELIMINATE THE ELSE STATEMENT
...
!        xin(ih1)   = 1.000000D-30
!        xin(ihe3)  = 3.000000D-30
!        xin(ihe4)  = 2.105683D-13
!        xin(ic12)  = 1.664450D-09
!        xin(in14)  = 1.400000D-29
!        xin(io16)  = 3.588701D-04
!        xin(ine20) = 9.567092D-10
!        xin(img24) = 1.348326D-07
!        xin(isi28) = 4.138866D-01
!        xin(is32)  = 4.033664D-01
!        xin(iar36) = 6.748411D-02
!        xin(ica40) = 1.149007D-01 
!        xin(iti44) = 3.133415D-06
!        xin(icr48) = 5.483846D-08
!        xin(ife52) = 1.043948D-10 
!        xin(ife54) = 5.317808D-11
!        xin(ini56) = 5.615613D-22 
!        xin(ineut) = 2.662527D-16  
!        xin(iprot) = 6.654586D-17
...
!
!        else if (self_heat_const_den) then
!         !write(22,07) 'self_heat:','   temp0=',y(itemp+kk), &! These 4 lines
!         !                         '   den0=',y(iden+kk)      ! were already
!         !write(23,07) 'self_heat:','   temp0=',y(itemp+kk), &! commented
!         !                         '   den0=',y(iden+kk)      ! out
!
...
! a zone in the w7 model as a function of time tt.

! declare  the pass
      double precision tt,den,temp


! table storage and interpolation
      character*40     infile
      integer          i,zone,ntime,ntmax,jmax,jat,norder
      parameter        (ntmax=500)
      double precision ztime(ntmax),zden(ntmax),ztemp(ntmax),dy



! small common on the mass points
      integer          w7zone,w7init
      common /w7mass/  w7zone,w7init
...
! set the zone number, there are 175 max
       zone = w7zone

!       write(6,*) 'initializing ',zone

! get the mass of the shell
       infile = 'w7_mass_shells.dat'
       call get_mshell(infile,zone,mshell,mint)


! get the density history
       infile = 'w7dens.dat'
       call shyg(infile,zone,ntmax,ntime,ztime,zden)


! get the temperature history
       infile = 'w7temp.dat'
       call shyg(infile,zone,ntmax,ntime,ztime,ztemp)

! pass the ending times back
       zwork1(1) = ztime(1)
       zwork1(2) = ztime(ntime)

! set the order of the interpolation (2 points = linear)
       norder = 2
      end if
...
! locate and interpolate to get the temperature and density
      call locate_w7(ztime,ntime,tt,jat)
      jat = max(1,min(jat - norder/2 + 1,ntime - norder + 1))
      call w7_polint(ztime(jat),ztemp(jat),norder,tt,temp,dy)
      call w7_polint(ztime(jat),zden(jat),norder,tt,den,dy)
      ...
      subroutine get_mshell(infile,zone,mshell,mint)
      include 'implno.dek'

! declare the pass
      character*40     infile
      integer          zone
      double precision mshell,mint


! internal variables
      integer          ifirst,nmax,i,j,mzones
      parameter        (nmax = 1000)
      double precision xm(nmax),xt(nmax),sum,msun
      parameter        (msun = 1.9892d33)
...
! set the return
      ...
      subroutine shyg(infile,zone,ntmax,ntime,time,var)
      include 'implno.dek'


! declare the pass
      character*40     infile
      integer          zone,ntmax,ntime
      double precision time(ntmax),var(ntmax)



! internals
      character*20     aa
      integer          nd,ncc,i,j,k,jj,kk,jk,i1(5)
      double precision rho(5)
      double precision ts(1000),rhops(1000)
...
! read the number of timesteps in the file
      read(17,*) nd
!      write(6,*) nd
      if (nd .gt. ntmax) stop 'nd > ntmax in routine shyg'
...
! read the header
       read(17,'(a19,5i9)',end=13) aa,(i1(k),k=1,5)
!       write(6,*) (i1(k),k=1,5)


! figure if this is the zone we want
       do k=1,5
        if(i1(k).eq.ncc) then
         kk=k
         goto 9
...
! read the time and density
       do j=1,nd
        read(17,*) jk,ts(j),(rho(k),k=1,5)

! store it if we want this zone
        if(kk.ne.0) then
         rhops(j)=rho(kk)
!         write(6,'(i4,1p6e10.3)') j,ts(j),rho(kk)
         if (j.eq.nd) goto 13
        endif
       enddo
...
! set the ouput
      ...
      subroutine w7_polint(xa,ya,n,x,y,dy)
      implicit none
      save
...
! locals
      ...
      double precision x(n),amass,fac1,fac2,tolf,tolx,twopi, &
                       dum,resid(n), &
                       xne,ge,sqrtge,sqrtgi, &
                       esqu,forthpi,third,fivth,a1,a2,a2inv, &
                       rt3,half_rt3,a3
...
! locals
      ...
      double precision ye,mu,fac1,fac2,fac3,sum,sum2, &
                       deninv,ww,hinv,twopih,mev2erg,mev2gr
      parameter        (hinv    = 1.0d0/h, &
                        twopih  = 2.0d0 * pi/h, &
                        mev2erg = ev2erg*1.0d6, &
                        mev2gr  = mev2erg/clight**2)
...
!       amass(i)     = nion(i)*mn + zion(i)*mp - bion(i)*mev2gr
...
! locals
      ...
      double precision mu,mubn,mubp, &
                       ...
                       xmbn(abignet),xmbp(abignet),sum,sumbn,sumbp, &
                       ye,yebn,yebp,deninv,ww,sum2,sum2bn,sum2bp, &
                       hinv,twopih,mev2erg,mev2gr
      parameter        (hinv  = 1.0d0/h, &
                        twopih  = 2.0d0 * pi/h, &
                        mev2erg = ev2erg*1.0d6, &
                        mev2gr  = mev2erg/clight**2)
...
!       fac5 = yei(i)
!       ye   = ye   + fac5 * xmass_nse(i)
!       yebn = yebn + fac5 * xmbn(i)
!       yebp = yebp + fac5 * xmbp(i)
      enddo
