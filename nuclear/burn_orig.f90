      subroutine init_nuclear_burning
        include 'implno.dek'
        include 'const.dek'
        include 'timers.dek'
        ...
        call init_aprox13
        return
      end subroutine init_nuclear_burning
...
! 
      ...
      subroutine getEOSInversion( temp, dens, abar, zbar, pressure, energy, soundspeed )
